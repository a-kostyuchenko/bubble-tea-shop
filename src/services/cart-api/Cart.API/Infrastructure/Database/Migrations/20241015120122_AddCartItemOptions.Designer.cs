...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cart.API.Entities.Carts.Option", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ExtraPrice", "Cart.API.Entities.Carts.Option.ExtraPrice#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Cart.API.Entities.Carts.Parameter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Cart.API.Entities.Carts.Option", b =>
                {
                    b.HasOne("Cart.API.Entities.Carts.Parameter", null)
                        .WithOne("SelectedOption")
                        .HasForeignKey("Cart.API.Entities.Carts.Option", "parameter_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Cart.API.Entities.Carts.Parameter", b =>
                {
                    b.HasOne("Cart.API.Entities.Carts.CartItem", null)
                        .WithMany("Parameters")
