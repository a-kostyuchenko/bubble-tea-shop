...
public static class DependencyInjection
{
    ...
    {
        Type[] domainEventHandlers = BubbleTea.Services.Payment.Application.AssemblyReference.Assembly
            .GetTypes()
    ...
    {
        Type[] integrationEventHandlers = global::BubbleTea.Services.Payment.Presentation.AssemblyReference.Assembly
            .GetTypes()
